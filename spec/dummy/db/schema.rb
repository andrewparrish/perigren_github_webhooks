...
ActiveRecord::Schema.define(version: 2021_01_25_010533) do
  ...
  create_table "installation_events_repositories", id: false, force: :cascade do |t|
    t.bigint "installation_event_id", null: false
    t.bigint "repository_id", null: false
  end

  create_table "installation_repositories_events", force: :cascade do |t|
    t.integer "installation_id"
    t.string "action"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_installation_repositories_events_on_account_id"
    t.index ["app_id"], name: "index_installation_repositories_events_on_app_id"
    t.index ["sender_id"], name: "index_installation_repositories_events_on_sender_id"
    t.index ["target_id"], name: "index_installation_repositories_events_on_target_id"
  end
  ...
  create_table "installations_repositories", id: false, force: :cascade do |t|
  ...
  create_table "organizations", force: :cascade do |t|
    ...
    t.string "avatar_url"
    t.text "description"
    t.index ["node_id"], name: "index_organizations_on_node_id"
  end
  ...
  create_table "repositories", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["node_id"], name: "index_repositories_on_node_id"
